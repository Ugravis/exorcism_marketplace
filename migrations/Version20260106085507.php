 ...
 */
final class Version20260106085507 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'add table : Review';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE review (id INT AUTO_INCREMENT NOT NULL, content LONGTEXT NOT NULL, rating NUMERIC(2, 1) NOT NULL, created_at DATETIME DEFAULT NULL, customer_id_id INT DEFAULT NULL, service_id_id INT DEFAULT NULL, INDEX IDX_794381C6B171EB6C (customer_id_id), INDEX IDX_794381C6D63673B0 (service_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
